	...
	return (
		<>
			<meta
				name={"description"}
				content={
					"Max Matthews: Applied AI Full Stack Javascript Developer. Mentor, Hacker, & Entrepreneur. Pursuing full-time, part-time, or 1099 contract roles. In person, remote, or relocation."
				}
			/>
			<meta
				name={"keywords"}
				content={
					"max matthews, full stack developer, applied ai, javascript, mentor, hacker, entrepreneur, careers in code, syracuse, ny, tuzag, cto"
				}
			/>
